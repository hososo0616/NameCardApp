            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class=" text-gray-900">
                    <section class="text-gray-600 body-font">
                        <form action="{{ route('namecard.update') }}" method="POST" enctype='multipart/form-data'>
                            @csrf
                            <div class="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center">
                                ...
                                <div
                                    ...
                                    <div class="flex justify-center">
                                        <button
                                            class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">編集する</button>
